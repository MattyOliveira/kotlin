        ...
        if (initializer != null) {
            ...
            if (inInterface) {
                ...
                val delegateClassDescriptor =
                    delegatedPropertyResolvedCall?.resultingDescriptor?.containingDeclaration as? ClassDescriptor
                ...
                if (usedParameter != null) {
                    var propertyWithTypeParameterTypeFound = delegateClassScope == null
                    val names = delegateClassScope?.getVariableNames().orEmpty()
                    for (name in names) {
